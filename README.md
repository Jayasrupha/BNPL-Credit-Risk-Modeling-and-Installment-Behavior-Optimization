...
1. Predict whether a customer is likely to default on a BNPL payment
2. Understand key factors driving repayment risk
3. Analyze how installment duration impacts financial burden and repayment behavior
4. Identify an optimal installment structure that balances risk and repayment performance
...
2. Installment Plan Analysis
  ...
  Studies how installment duration affects: Default rate, Repayment delays, Missed payments, Repayment success
